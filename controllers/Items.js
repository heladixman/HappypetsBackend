...
export const getItemsLastUploadAdmin = async (req, res) => {
  try {
    const response = await Items.findAll({
      attributes: [
        ["itemName", "itemName"],
...
export const getTopProductAdmin = async (req, res) => {
  try {
    const response = await Items.findAll({
      attributes: [
        ["itemName", "itemName"],
...
export const createItem = async (req, res) => {
  ...
  const productExist = await Items.findOne({
    where: { name: req.body.productName },
  });
